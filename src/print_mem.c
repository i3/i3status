 ...
 *
 */
static int print_bytes_human(char *outwalk, unsigned long bytes, const char *unit, const int decimals, bool compact) {
    double base = bytes;
    size_t exponent = 0;
...
void print_memory(memory_ctx_t *ctx) {
    ...
    print_bytes_human(string_ram_total, ram_total, ctx->unit, ctx->decimals, ctx->compact);
    print_bytes_human(string_ram_used, ram_used, ctx->unit, ctx->decimals, ctx->compact);
    print_bytes_human(string_ram_free, ram_free, ctx->unit, ctx->decimals, ctx->compact);
    print_bytes_human(string_ram_available, ram_available, ctx->unit, ctx->decimals, ctx->compact);
    print_bytes_human(string_ram_shared, ram_shared, ctx->unit, ctx->decimals, ctx->compact);
